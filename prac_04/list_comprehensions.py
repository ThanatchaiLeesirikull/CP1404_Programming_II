...
for number in almost_numbers:
    lists_integer_1.append(int(number))
print(lists_integer_1)
...
for number in almost_numbers:
    if int(number) > 9:
        lists_integer_2.append(int(number))
print(lists_integer_2, end='\n')
